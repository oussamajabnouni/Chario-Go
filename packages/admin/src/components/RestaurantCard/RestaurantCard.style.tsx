...
export const RestaurantCardWrapper = styled('div', ({ $theme }) => ({
  height: '100%',
  width: '100%',
...
export const RestaurantImageWrapper = styled('div', ({ $theme }) => ({
  height: '240px',
  padding: '5px',
  position: 'relative',
...
export const RestaurantInfo = styled('div', ({ $theme }) => ({
...
export const RestaurantTitle = styled('h3', ({ $theme }) => ({
...
export const RestaurantWeight = styled('span', ({ $theme }) => ({
...
export const RestaurantMeta = styled('div', ({ $theme }) => ({
  marginTop: '15px',
  display: 'flex',
  alignItems: 'center',
...
export const RestaurantPriceWrapper = styled('div', ({ $theme }) => ({
  display: 'flex',
  alignItems: 'center',
  position: 'relative',
}));

export const RestaurantPrice = styled('span', ({ $theme }) => ({
  ...$theme.typography.fontBold14,
